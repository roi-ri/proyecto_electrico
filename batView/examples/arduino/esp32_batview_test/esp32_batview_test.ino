/*
  Minimal ESP32 sketch to validate batView serial protocol from Arduino IDE.

  Default behavior:
  - Accepts batView commands over USB serial at 115200 baud.
  - Replies with the ACK frames batView expects.
  - Periodically streams #DATA frames after LOAD, UNLOAD, or CICLE.

  Test behavior:
  - Set one of the SEND_ACK_* flags to false to simulate "connected but no ACK".
  - Set one of the SEND_ERROR_ON_* flags to true to simulate #ERROR responses.
*/
