...
2. **ESP32 encargado del sistema de control:** ejecutará el algoritmo de control
...
De esta manera, el C2000 simulará el circuito de la PCB y el ESP32 realizará el control
de corriente.
